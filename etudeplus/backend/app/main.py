...
# 0. Security Headers — must be first to ensure all responses have security headers
...
if SERVE_FRONTEND and STATIC_DIR.exists():
    ...
    async def serve_spa(request: Request, full_path: str):
        ...
        API routes are handled by the api_router above.
        """
        ...
        return {"message": "SchoolFlow Pro API", "version": settings.APP_VERSION}

    logger.info("Frontend static files enabled, serving from /app/static")
